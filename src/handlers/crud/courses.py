...
class CourseInterfaceAdmin(AdminInterface):
    ...
    @staticmethod
    async def start_add_new_course(message: Message, state: FSMContext):
    ...
    @staticmethod
    async def cancel(message: Message, state: FSMContext, keyboard):
    ...
    @staticmethod
    async def previous(message: Message, state: FSMContext):
